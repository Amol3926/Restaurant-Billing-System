...
def bill_button_operation():
    ...
    if ans=="yes":
        ...
        st = "\t\t\tAmol's Restaurant\n\t\tAmol Gaikwad/ Pune Road, Aurangabad-431001\n"
...
root.title("Welcome To Amol Restaurant  || Developed By Amol Gaikwad")
...
title_label = Label(title_frame, text="Welcome To Amol's Restaurant",bd=12,relief='raise', font=('arial',24,'bold'),bg='orange',pady=5)
title_label.pack()
